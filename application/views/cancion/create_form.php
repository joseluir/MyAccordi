...
?>
  ...
  <h2 style="margin-top:0px">Crear Cancion</h2>
 
 
        
 <div class="container">

 <?php echo form_open_multipart('cancion/create_action',$atributos); ?>
...
<table>
		...
		<tr>
			...
			<td>
				<p>Selecciona el audio de la cancion dando click sobre el <strong> boton azul</strong>. </p>
        ...
        <tr>
			<td>&nbsp</td>
			<td id='msg_letra' style="color: red;"> <?php echo form_error('letra') ?></td>
		</tr>
		<tr>
			<td>&nbsp</td>
			<td>&nbsp</td>
	    ...
	    <tr>
	    	<td>&nbsp</td>
	    	<td><?php echo form_submit('register', 'Crear Cancion',"class='btn btn-lg btn-success btn-block'"); ?></td>
	    </tr>
	    <tr>
			<td>&nbsp</td>
			<td>&nbsp</td>
