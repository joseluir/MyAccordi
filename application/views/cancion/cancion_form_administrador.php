...
?>
 ...
 <?php echo form_open_multipart('cancion/update_admin_action',$atributos); ?>
...
<table>
		...
		<tr>
			...
			<td>
				<p>Dando click sobre el <strong> boton azul</strong> podras seleccionar el nuevo audio de la cancion . </p>
	    ...
	    <tr>
	    	<td>&nbsp</td>
	    	<td><a href="<?php echo site_url('cancion/') ?>" class="btn btn-lg btn-default btn-block">Cancelar</a></td>
	    </tr>
