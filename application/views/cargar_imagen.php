...
<table>
	...
	<tr>
		<td>
			...
			**********************************************************************************************/
			?>
			<p class="lead">Selecciona una imagen dando click sobre el <strong> boton examinar</strong>. </p>
	...
	<tr>
		<?php $data['name'] = 'filename'; $data['class'] = 'btn btn-lg btn-success'; ?>
	...
	<tr>
		<td>
			<?php echo form_submit('submit', 'Subir imagen',"class='btn btn-lg btn-success btn-block'"); ?>
		</td>
	</tr>
